...
interface IArtFallonMarketplace {
 ...
 */
contract ArtFallonAuction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMath for uint256;
    using AddressUpgradeable for address payable;
    using SafeERC20 for IERC20;

    /// @notice Event emitted only on construction. To be used by indexers
    event ArtFallonAuctionContractDeployed();
        ...
        initializer
    {
        require(
            ...
            "ArtFallonAuction: Invalid Platform Fee Recipient"
        );

        platformFeeRecipient = _platformFeeRecipient;
        emit ArtFallonAuctionContractDeployed();
 ...
 */
        ...
        nonReentrant
    {
        ...
        IArtFallonMarketplace marketplace = IArtFallonMarketplace(
        ...
        emit AuctionResulted(
            ...
            winner,
            auction.payToken,
            IArtFallonMarketplace(addressRegistry.marketplace()).getPrice(
                auction.payToken
            ),
            winningBid
        );
