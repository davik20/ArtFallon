...
import "./ArtFallonArtTradable.sol";

contract ArtFallonArtFactory is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new ArtFallonArtTradable contract
        ...
        returns (address)
    {
        ...
        ArtFallonArtTradable nft = new ArtFallonArtTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
