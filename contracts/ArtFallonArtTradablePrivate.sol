...
/**
 * @title ArtFallonArtTradablePrivate
 * ArtFallonArtTradablePrivate - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract ArtFallonArtTradablePrivate is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
{
    ...
    // ArtFallon Marketplace contract
    address marketplace;
    // ArtFallon Bundle Marketplace contract
    ...
    {
        // Whitelist ArtFallon marketplace, bundle marketplace contracts for easy trading.
