...
import "./ArtFallonArtTradablePrivate.sol";

contract ArtFallonArtFactoryPrivate is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new ArtFallonArtTradablePrivate contract
        ...
        returns (address)
    {
        ...
        ArtFallonArtTradablePrivate nft = new ArtFallonArtTradablePrivate(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
    ...
    /// @notice Method for registering existing ArtFallonArtTradable contract
    ...
    /// @notice Method for disabling existing ArtFallonArtTradable contract
    /// @param  tokenContractAddress Address of NFT contract
