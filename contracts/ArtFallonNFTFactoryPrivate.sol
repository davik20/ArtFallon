...
import "./ArtFallonNFTTradablePrivate.sol";

contract ArtFallonNFTFactoryPrivate is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice ArtFallon auction contract address;
    address public auction;

    /// @notice ArtFallon marketplace contract address;
    address public marketplace;

    /// @notice ArtFallon bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new ArtFallonNFTTradable contract
        ...
        returns (address)
    {
        ...
        ArtFallonNFTTradablePrivate nft = new ArtFallonNFTTradablePrivate(
            _name,
            _symbol,
            auction,
            marketplace,
    ...
    /// @notice Method for registering existing ArtFallonNFTTradable contract
    ...
    /// @notice Method for disabling existing ArtFallonNFTTradable contract
    /// @param  tokenContractAddress Address of NFT contract
