...
/**
 * @title ArtFallonNFTTradable
 * ArtFallonNFTTradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract ArtFallonNFTTradable is ERC721, Ownable {
