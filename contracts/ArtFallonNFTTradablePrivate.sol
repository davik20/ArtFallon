...
/**
 * @title ArtFallonNFTTradablePrivate
 * ArtFallonNFTTradablePrivate - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract ArtFallonNFTTradablePrivate is ERC721, Ownable {
    ...
    */
    ...
    /**
     * Override isApprovedForAll to whitelist ArtFallon contracts to enable gas-less listings.
     */
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist ArtFallon auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist ArtFallon contracts to enable gas-less listings.
     */
