...
contract ArtFallonPriceFeed is Ownable {
    /// @notice keeps track of oracles for each tokens
    mapping(address => address) public oracles;

    /// @notice ArtFallon address registry contract
    ...
    function registerOracle(address _token, address _oracle)
        ...
        onlyOwner
    {
        IArtFallonTokenRegistry tokenRegistry = IArtFallonTokenRegistry(
            IArtFallonAddressRegistry(addressRegistry).tokenRegistry()
        );
